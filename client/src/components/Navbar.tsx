      ...
      <div className="container-custom flex items-center justify-between gap-4">
        <Link href="/" className="group flex items-center gap-3 font-mono font-bold text-lg md:text-xl tracking-tighter relative z-50 flex-shrink-0">
          <div className="flex flex-col text-right">
            <span className="leading-none text-xl md:text-2xl font-black">TechnoHacks</span>
            <span className="text-[8px] md:text-[10px] text-accent font-mono tracking-[0.2em] font-bold uppercase">Edutech IoT</span>
          </div>
